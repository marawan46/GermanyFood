...
useAnimateOnScroll([selectedCategory])
  return (
    ...
    <Hero setSearchQuery={setSearchQuery} searchQuery={searchQuery}/>
      {/* Category Selection */}
      <CategoryFilterWithScroll categories={categories} catLoading={catLoading} selectedCategory={selectedCategory} setSelectedCategory={setSelectedCategory}/>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="relative">
          ...
          >
            <ProductCarousel products={products} productsLoading={productsLoading} setShowAllergyModal={setShowAllergyModal} id={"HOT"}/>
          </div>
        </div>
      </div>
